skills <- tribble(
  ...
  "High throughput proteomics", "Trypsin digestion, immunodepletion of serum &/or plasma samples, label free quantification (DIA and DDA based), isobaric labeling, off-line high pH fractionation, PTMs enrichment, immunoprecipitation experiments and targeted proteomics measurements",
  ...
  "Chromatography instrumentation ", "Easy nLC series (Thermo Scientific), Evosep One",
  "Automation platform", "SP100 Automation instrument (Hamilton robot), Biomek i-Series Automated workstation", 
  "Programming languages and softwares ", " R, Python, Machine learning, Jupyter enviornment, Omics data, Cytoscape and Ingenuity Pathway Analysis "
)
...
work <- tribble(
  ...
  "Associate Scientific Manager", "Innoplexus Consulting Pvt Ltd", "August", 2024, "November", 2024, "Pune - India","Data curation for the outputs generated via different modules built to accelerate the drug discovery and development process using AI/ML approach",
  "Associate Scientific Manager", "Innoplexus Consulting Pvt Ltd", "August", 2024, "November", 2024, "Pune - India","Collaboration with data engineers and data scientists in an agile enviornment",
  "Associate Scientific Manager", "Innoplexus Consulting Pvt Ltd", "August", 2024, "November", 2024, "Pune - India","NA",
  "Associate Biomedical Scientist", "Cedars-Sinai Precision Biomarker Laboratories", "February", 2023, "June", 2024, "Los Angeles - USA","Applied mass spectrometry based proteomics technlogy to study the complexity of proteome", 
  "Associate Biomedical Scientist", "Cedars-Sinai Precision Biomarker Laboratories", "February", 2023, "June", 2024, "Los Angeles - USA","Client facing role", 
...
pubs <- tribble(
  ...
  "Moulder R, Bhosale SD, Viiri K, Lahesmaa R","Comparative proteomics analysis of the mouse mini-gut organoid: insights into markers of gluten challenge from celiac disease intestinal biopsies", "Front. Mol. Biosci","2024",
  "Hendricks NG, Bhosale SD, Keoseyan AJ, Ortiz J, Stotland A, Seyedmohammad S, Nguyen CDL, Bui JT, Moradian A, Mockus SM, Van Eyk JE","An Inflection Point in High-Throughput Proteomics with Orbitrap Astral: Analysis of Biofluids, Cells, and Tissues","J Proteome Res","2024",
  "Bhosale SD, Moulder R, Suomi T, Ruohtula T, Honkanen J, Virtanen SV, Ilonen J, ELo LL, Knip M, Lahesmaa R", "Serum proteomics of mother-infant dyads carrying HLA-conferred type 1 diabetes risk","iScience","2024",
