...
work <- tribble(
  ...
  "Associate Biomedical Scientist", "Cedars-Sinai Precision Biomarker Laboratories", "February", 2023, "Present", NA, "Los Angeles - USA","Applying mass spectrometry based proteomics technlogy to study the complexity of proteome", 
