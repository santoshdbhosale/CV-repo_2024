skills <- tribble(
  ...
  "Data curation ", "Data validation for output generated by AI and ML model, working in an agile enviornment, database mining, Llama prompt refinement"
)
...
ref <- tribble(
  ...
  'Annie Moradian, Ph.D.', "Lead Scientist, Precision Biomarker Laboratories, Cedars-Sinai Medical Center, Beverly Hills, California 90210, United States", "Annie.Moradian@cshs.org",
  'Susan Mockus, Ph.D., MBA', "Executive Director, Precision Biomarker Laboratories, Cedars-Sinai Medical Center, Beverly Hills, California 90210, United States", "Susan.Mockus@cshs.org"
